...
/*========================================================================*/
void dummy 						  (void);
extern void SW1_ISR(void);
extern void SW2_ISR(void);
...
(uint32_t) &SW1_ISR, /* Vector # 243 SIUL EIRQ [0-7] - SIUL Combined External Interrupt */
(uint32_t) &SW2_ISR, /* Vector # 244 SIUL EIRQ [8-15] - SIUL Combined External Interrupt */
